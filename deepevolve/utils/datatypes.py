...
# Models accessed via LiteLLM prefix (e.g. "litellm/claude-sonnet-4-6")
# These do not support OpenAI reasoning_effort settings.
litellm_models = [
    "claude-sonnet-4-6",
...
def is_litellm_model(model_name: str) -> bool:
    """Return True if this model should be accessed via the litellm/ prefix."""
    if model_name is None:
        return False
    bare = model_name.removeprefix("litellm/")
    return bare in litellm_models or model_name.startswith("litellm/")
